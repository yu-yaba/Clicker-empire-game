...
function createItemList (userData, itemList) {
    ...
    purchaseBtn.addEventListener("click", function () {
        ...
        } else if (itemList[i].purchaseLimit == userData["itemList[i].purchaseLimit == userData["belongings"][i].purchaseQuantity"][i].purchaseQuantity) {
    ...
    let total = totalAmount * itemList[i].price;
        if (total > parseInt(userData.money)) {
            return alert("お金が足りません");
        } else if (itemList[i].purchaseLimit <= userData["belongings"][i].purchaseQuantity) {
            return alert("これ以上購入できません");
        } else {
