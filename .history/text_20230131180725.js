...
function createHamburger (userData) {
    ...
    hamburgerCon.classList.add("col-12", "col-md-4", "text-center", "flex-column", "justify-content-center");
...
function createMainPage (userData) {
    ...
    mainPageCon.classList.add("vh-100", "bg-blue", "d-flex", "justify-content-center", "flex-wrap", "col-10")
    ...
    headerCon.classList.add("row", "col-9");
    ...
    bodyCon.classList.add("row", "d-flex", "justify-content-center" ,"align-items-center");
