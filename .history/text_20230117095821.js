...
class UserAccount {
    constructor(name, age, days, money, profitPerClick, profitPerSeconds, belongings, humberger){
        this.name = name;
        this.age = age;
        this.days = days;
        this.money = money;
...
function loginAccount () {
    ...
    if (saveData == null) {alert("データが見つかりませんでした");
        ...
        let userData = new UserAccount(saveData["name"], saveData["age"], saveData["days"], saveData["money"], saveData["profitPerClick"], saveData["profitPerSeconds"], loginItems, saveData["humberger"]);
    }
