...
function createBalanceInfo (userData) {
    ...
    balanceInfoCon.classList.add("d-flex","justify-content-center", "align-items-center");
...
function createMainPage (userData) {
    ...
    mainPageCon.classList.add("vh-100", "bg-blue", "d-flex", "justify-content-center", "flex-wrap")
    ...
    headerCon.classList.add("row", "col-12");
