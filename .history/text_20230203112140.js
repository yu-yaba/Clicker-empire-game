...
function loginAccount () {
    ...
    if (saveData == null) {alert("データが見つかりませんでした");
        ...
        for (let i = 0; i < saveData["belongings"].length; i++) {
            ...
            loginItems.push(new Item(eachItem["name"], eachItem["price"], eachItem["purchaseLimit"], eachItem["purchaseQuantity"], eachItem["purchaseQuantity"], eachItem["type"], eachItem["type"]))
        }
