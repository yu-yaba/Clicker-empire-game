...
function createItemList (userData, itemList) {
    ...
    let totalAmount = 0;
        if(totalAmount < itemList[i].purchaseLimit - itemList[i].purchaseQuantity) {
            totalAmount = parseInt(userData.money / itemList[i].price)
        } else {
            for (let j = 0; j < itemList[i].purchaseLimit - itemList[i].purchaseQuantity; j++) {
                totalAmount ++;
                if (totalAmount < itemList[i].purchaseLimit - itemList[i].purchaseQuantity) totalAmount = parseInt(userData.money / itemList[i].price)
            }
        }
