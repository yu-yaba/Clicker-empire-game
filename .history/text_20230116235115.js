...
function registerAccount () {
    let player;
    if (userName.value == "yuya") player = new UserAccount(userName.value, 20, 0, 10000000, 100000, 1000, items, 0);
    else player = new UserAccount (userName.value, 20, 0, 30000, 0, 0, items, 0);
...
function loginAccount () {
    let saveData = localStorage.getItem
}
