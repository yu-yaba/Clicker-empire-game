...
function startInterval (userData) {
    config.querySelectorAll("p").item(1).innerHTML = `[$${userData.clickUnitPrice}/click]`;
    config.querySelectorAll("p").item(2).innerHTML = `[$${userData.secondsUnitPrice.toFixed()}/days]`;
