    ...
    for (let i = 0; i < itemList.length; i++) {
        ...
        <div class="d-flex row eachItemCon justify-content-center m-0">
            ...
            <div class="col-3 d-flex flex-wrap align-items-center justify-content-center">
                <button class="btn btn-info purchase-btn mx-2">× 1</button>
                <button class="btn btn-primary max-btn mx-1">max</button>
            </div>
...
function createSaveData (userData) {
...
function createMainPage (userData) {
    ...
    config.dataInfo.append(createSaveData(userData));
