...
function createItemList (userData, itemList) {
    ...
    purchaseBtn.addEventListener("click", function () {
        if (parseInt(itemList[i].price) > parseInt(userData.money)) {
            ...
            userData.addP(itemList[i].increaseAssets(itemList[i].profit), itemList[i].type);
    ...
    let total = totalAmount * itemList[i].price;
        if (total > userData.money) {
            ...
            userData.addP(itemList[i].increaseAssets(parseInt(itemList[i].profit * totalAmount)), itemList[i].type);
