...
function registerAccount () {
    if (config.userName.value === "yuya") new UserAccount(yuya, 20, 0, 10000000, 100000, 1000, itemList, 0);
    else if (config.userName.value == "") {
        return alert (`名前を入力して下さい`); 
    }
    else new UserAccount (config.userName.value, 20, 0, 30000, 100, 0, itemList, 0);
