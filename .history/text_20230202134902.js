...
function createHamburger (userData) {
    ...
    <div class="container-fluid">
        <img alt="" src='https://icons.veryicon.com/png/o/food--drinks/flat-color-restaurant-icon/hamburger-8.png' class="hamburger-btn" width="65%">
    </div>
    `
...
function createItemList (userData, itemList) {
    ...
    for (let i = 0; i < itemList.length; i++) {
        ...
        <div class="d-flex row eachItemCon justify-content-center m-0">
            ...
            <div class="col-3 d-flex flex-wrap align-items-center justify-content-center">
                ...
                <button class="max-btn mx-1">max</button>
            </div>
    ...
    purchaseBtn.addEventListener("click", function () {
        if (parseInt(itemList[i].price) > parseInt(userData.money)) {
            ...
            // AvailabilityPurchase(itemList[i].querySelectorAll(".possession"), false);
    ...
    setInterval (function() {
        ...
        if(parseInt(itemList[i].price) > parseInt(userData.money) || total > parseInt(userData.money) || itemList[i].purchaseLimit <= itemList[i].purchaseQuantity) {
            AvailabilityPurchase(eachItemCon.querySelectorAll(".possession")[i], false);
        }
        else             AvailabilityPurchase(eachItemCon.querySelectorAll(".possession")[i], false);
